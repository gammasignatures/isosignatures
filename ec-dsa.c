...
typedef struct ECDSA_SignSessD3b ECDSA_SignSessD3b;
struct ECDSA_SignSessD3b
{
	BIGNUM*         r;
	BIGNUM*			r_inv;
	EC_POINT*       A;
...
typedef struct ECDSA_VrfySessD3b ECDSA_VrfySessD3b;
struct ECDSA_VrfySessD3b
{
	unsigned char*  e_bytes;
	BIGNUM*         e;
	BIGNUM*			z_inv;
...
typedef struct ECDSA_SignSessD2b ECDSA_SignSessD2b;
struct ECDSA_SignSessD2b
{
	BIGNUM*         r;
	BIGNUM*			r_inv;
	EC_POINT*       A;
...
typedef struct ECDSA_VrfySessD2b ECDSA_VrfySessD2b;
struct ECDSA_VrfySessD2b
{
	unsigned char*  e_bytes;
	BIGNUM*         e;
	BIGNUM*			z_inv;
...
void *ECDSA_keypair_new(int sec)
{
	...
	ret = calloc(1,sizeof(ECDSA_KeyPair));
...
void ECDSA_d3b_signsess_free(void* obj)
{
	if (obj == NULL) return;
	ECDSA_SignSessD3b *sess = (ECDSA_SignSessD3b*)obj;
	BN_free(sess->r);
	BN_free(sess->r_inv);
	EC_POINT_free(sess->A);
	BN_free(sess->dx);
...
void *ECDSA_d3b_signsess_new(void *keyobj)
{
	ECDSA_KeyPair *keypair = (ECDSA_KeyPair*)keyobj;

	ECDSA_SignSessD3b *sess = malloc(sizeof(ECDSA_SignSessD3b));
	if (sess == NULL) return NULL;

	memset(sess, 0, sizeof(ECDSA_SignSessD3b));
	...
	return sess;
err:
	ECDSA_d3b_signsess_free(sess);
	return NULL;
}


void ECDSA_d3b_vrfysess_free(void* obj)
{
	if (obj == NULL) return;
	ECDSA_VrfySessD3b *sess = (ECDSA_VrfySessD3b*)obj;
	free(sess->e_bytes);
	BN_free(sess->e);
	BN_free(sess->z_inv);
...
void *ECDSA_d3b_vrfysess_new(void *keyobj)
{
	ECDSA_KeyPair *keypair = (ECDSA_KeyPair*)keyobj;
	ECDSA_VrfySessD3b *sess = malloc(sizeof(ECDSA_VrfySessD3b));
	if (sess == NULL) return NULL;
	memset(sess, 0, sizeof(ECDSA_VrfySessD3b));
	...
	return sess;
err:
	ECDSA_d3b_vrfysess_free(sess);
	return NULL;
}


int ECDSA_d3b_sign_offline(void *keyobj, void *sessobj, void *sigobj)
{
	/* Rename objects. */
	ECDSA_KeyPair *keys = (ECDSA_KeyPair*)keyobj;
	ECDSA_SignSessD3b *sess = (ECDSA_SignSessD3b*)sessobj;
	ECDSA_Sig *sig = (ECDSA_Sig*)sigobj;
	int ret;
...
int ECDSA_d3b_sign_online(void *keyobj, void *sessobj, void *sigobj,
	const unsigned char *msg, int msglen)
{
	/* Cast objects. */
	ECDSA_KeyPair *keys = (ECDSA_KeyPair*)keyobj;
...
int ECDSA_d3b_vrfy_offline(void *keyobj, void *sessobj, void *sigobj, const unsigned char *msg, int msglen)
{
	ECDSA_KeyPair *keys = (ECDSA_KeyPair*)keyobj;
	ECDSA_VrfySessD3b *sess = (ECDSA_VrfySessD3b*)sessobj;
	ECDSA_Sig *sig = (ECDSA_Sig*)sigobj;
	int ret;
...
int ECDSA_d3b_vrfy_online(void *keyobj, void *sessobj, void *sigobj)
{
	/* Rename objects. */
	ECDSA_KeyPair *keys = (ECDSA_KeyPair*)keyobj;
	ECDSA_VrfySessD3b *sess = (ECDSA_VrfySessD3b*)sessobj;
...
void *ECDSA_d2b_signsess_new(void *keyobj)
{
	ECDSA_KeyPair *keypair = (ECDSA_KeyPair*)keyobj;

	ECDSA_SignSessD2b *sess = malloc(sizeof(ECDSA_SignSessD2b));
	if (sess == NULL) return NULL;

	memset(sess, 0, sizeof(ECDSA_SignSessD2b));
	...
	return sess;
err:
	ECDSA_d2b_signsess_free(sess);
	return NULL;
}


void ECDSA_d2b_signsess_free(void* obj)
{
	if (obj == NULL) return;
	ECDSA_SignSessD2b *sess = (ECDSA_SignSessD2b*)obj;
	BN_free(sess->r);
	BN_free(sess->r_inv);
	EC_POINT_free(sess->A);
	BN_free(sess->dx);
...
void *ECDSA_d2b_vrfysess_new(void *keyobj)
{
	ECDSA_KeyPair *keypair = (ECDSA_KeyPair*)keyobj;
	ECDSA_VrfySessD2b *sess = malloc(sizeof(ECDSA_VrfySessD2b));
	if (sess == NULL) return NULL;
	memset(sess, 0, sizeof(ECDSA_VrfySessD2b));
	...
	return sess;
err:
	ECDSA_d2b_vrfysess_free(sess);
	return NULL;
}


void ECDSA_d2b_vrfysess_free(void* obj)
{
	if (obj == NULL) return;
	ECDSA_VrfySessD2b *sess = (ECDSA_VrfySessD2b*)obj;
	free(sess->e_bytes);
	BN_free(sess->e);
	BN_free(sess->z_inv);
	EC_POINT_free(sess->A);
...
int ECDSA_d2b_sign_offline(void *keyobj, void *sessobj, void *sigobj)
{
	/* Rename objects. */
	ECDSA_KeyPair *keys = (ECDSA_KeyPair*)keyobj;
	ECDSA_SignSessD2b *sess = (ECDSA_SignSessD2b*)sessobj;
	ECDSA_Sig *sig = (ECDSA_Sig*)sigobj;
	int ret;
...
int ECDSA_d2b_sign_online(void *keyobj, void *sessobj, void *sigobj,
	const unsigned char *msg, int msglen)
{
...
int ECDSA_d2b_vrfy_offline(void *keyobj, void *sessobj, void *sigobj)
{
	return 0;
}


int ECDSA_d2b_vrfy_online(void *keyobj, void *sessobj, void *sigobj, const unsigned char *msg, int msglen)
{
	/* Rename objects. */
	ECDSA_KeyPair *keys = (ECDSA_KeyPair*)keyobj;
	ECDSA_VrfySessD2b *sess = (ECDSA_VrfySessD2b*)sessobj;
	ECDSA_Sig *sig = (ECDSA_Sig*)sigobj;
	int ret;
...
SchemeMethods ECDSA_Methods =
{
    ...
    .mthd_signsess_d3b_new = ECDSA_d3b_signsess_new,
    .mthd_signsess_d3b_free = ECDSA_d3b_signsess_free,
    .mthd_vrfysess_d3b_new = ECDSA_d3b_vrfysess_new,
    .mthd_vrfysess_d3b_free = ECDSA_d3b_vrfysess_free,
    .mthd_d3b_sign_offline = ECDSA_d3b_sign_offline,
    .mthd_d3b_sign_online = ECDSA_d3b_sign_online,
    .mthd_d3b_vrfy_offline = ECDSA_d3b_vrfy_offline,
    .mthd_d3b_vrfy_online = ECDSA_d3b_vrfy_online,
    ...
    .mthd_signsess_d2b_new = ECDSA_d2b_signsess_new,
    .mthd_signsess_d2b_free = ECDSA_d2b_signsess_free,
    .mthd_vrfysess_d2b_new = ECDSA_d2b_vrfysess_new,
    .mthd_vrfysess_d2b_free = ECDSA_d2b_vrfysess_free,
    .mthd_d2b_sign_offline = ECDSA_d2b_sign_offline,
    .mthd_d2b_sign_online = ECDSA_d2b_sign_online,
    .mthd_d2b_vrfy_offline = ECDSA_d2b_vrfy_offline,
    .mthd_d2b_vrfy_online = ECDSA_d2b_vrfy_online,
