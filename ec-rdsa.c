...
typedef struct ECRDSA_SignSessD3b ECRDSA_SignSessD3b;
struct ECRDSA_SignSessD3b
...
typedef struct ECRDSA_VrfySessD3b ECRDSA_VrfySessD3b;
struct ECRDSA_VrfySessD3b
...
void ECRDSA_d3b_signsess_free(void* obj)
{
    if (obj == NULL) return;
    ECRDSA_SignSessD3b *sess = (ECRDSA_SignSessD3b*)obj;
    BN_free(sess->r);
    BN_free(sess->r_inv);
    EC_POINT_free(sess->A);
    BN_free(sess->dx);
...
void *ECRDSA_d3b_signsess_new(void *keyobj)
{
    ECRDSA_KeyPair *keypair = (ECRDSA_KeyPair*)keyobj;

    ECRDSA_SignSessD3b *sess = malloc(sizeof(ECRDSA_SignSessD3b));
    if (sess == NULL) return NULL;

    memset(sess, 0, sizeof(ECRDSA_SignSessD3b));
    ...
    return sess;
err:
    ECRDSA_d3b_signsess_free(sess);
    return NULL;
}


void ECRDSA_d3b_vrfysess_free(void* obj)
{
    if (obj == NULL) return;
    ECRDSA_VrfySessD3b *sess = (ECRDSA_VrfySessD3b*)obj;
    free(sess->e_bytes);
    BN_free(sess->e);
    BN_free(sess->e_inv);
    BN_free(sess->nil);
    BN_free(sess->d_e_inv);
    BN_free(sess->z_e_inv);
    BN_free(sess->neg_d_e_inv);
    EC_POINT_free(sess->A);
    BN_free(sess->d0);
    free(sess);
...
void *ECRDSA_d3b_vrfysess_new(void *keyobj)
{
    ECRDSA_KeyPair *keypair = (ECRDSA_KeyPair*)keyobj;
    ECRDSA_VrfySessD3b *sess = malloc(sizeof(ECRDSA_VrfySessD3b));
    if (sess == NULL) return NULL;
    memset(sess, 0, sizeof(ECRDSA_VrfySessD3b));
    ...
    flag = sess->e_inv = BN_new();if (flag == NULL) goto err;
    flag = sess->d_e_inv = BN_new();if (flag == NULL) goto err;
    flag = sess->z_e_inv = BN_new();if (flag == NULL) goto err;
    flag = sess->neg_d_e_inv = BN_new();if (flag == NULL) goto err;
    flag = sess->A = EC_POINT_new(keypair->group);if (flag == NULL) goto err;
    flag = sess->d0 = BN_new();if (flag == NULL) goto err;
    return sess;
err:
    ECRDSA_d3b_vrfysess_free(sess);
    return NULL;
}


int ECRDSA_d3b_sign_offline(void *keyobj, void *sessobj, void *sigobj)
{
    /* Rename objects. */
    ECRDSA_KeyPair *keys = (ECRDSA_KeyPair*)keyobj;
    ECRDSA_SignSessD3b *sess = (ECRDSA_SignSessD3b*)sessobj;
    ECRDSA_Sig *sig = (ECRDSA_Sig*)sigobj;
    int ret;
...
int ECRDSA_d3b_sign_online(void *keyobj, void *sessobj, void *sigobj,
    const unsigned char *msg, int msglen)
{
    /* Cast objects. */
    ECRDSA_KeyPair *keys = (ECRDSA_KeyPair*)keyobj;
...
int ECRDSA_d3b_vrfy_offline(void *keyobj, void *sessobj, void *sigobj, const unsigned char *msg, int msglen)
{
    ECRDSA_KeyPair *keys = (ECRDSA_KeyPair*)keyobj;
    ECRDSA_VrfySessD3b *sess = (ECRDSA_VrfySessD3b*)sessobj;
    ECRDSA_Sig *sig = (ECRDSA_Sig*)sigobj;
    int ret;
...
int ECRDSA_d3b_vrfy_online(void *keyobj, void *sessobj, void *sigobj)
{
    /* Rename objects. */
    ECRDSA_KeyPair *keys = (ECRDSA_KeyPair*)keyobj;
    ECRDSA_VrfySessD3b *sess = (ECRDSA_VrfySessD3b*)sessobj;
...
typedef struct ECRDSA_SignSessD2b ECRDSA_SignSessD2b;
struct ECRDSA_SignSessD2b
...
typedef struct ECRDSA_VrfySessD2b ECRDSA_VrfySessD2b;
struct ECRDSA_VrfySessD2b
...
void ECRDSA_d2b_signsess_free(void* obj)
{
    if (obj == NULL) return;
    ECRDSA_SignSessD2b *sess = (ECRDSA_SignSessD2b*)obj;
    BN_free(sess->r);
    BN_free(sess->r_inv);
    EC_POINT_free(sess->A);
    BN_free(sess->dx);
...
void *ECRDSA_d2b_signsess_new(void *keyobj)
{
    ECRDSA_KeyPair *keypair = (ECRDSA_KeyPair*)keyobj;

    ECRDSA_SignSessD2b *sess = malloc(sizeof(ECRDSA_SignSessD2b));
    if (sess == NULL) return NULL;

    memset(sess, 0, sizeof(ECRDSA_SignSessD2b));
    ...
    return sess;
err:
    ECRDSA_d2b_signsess_free(sess);
    return NULL;
}


void ECRDSA_d2b_vrfysess_free(void* obj)
{
    if (obj == NULL) return;
    ECRDSA_VrfySessD2b *sess = (ECRDSA_VrfySessD2b*)obj;
    free(sess->e_bytes);
    BN_free(sess->e);
    BN_free(sess->e_inv);
    BN_free(sess->nil);
...
void *ECRDSA_d2b_vrfysess_new(void *keyobj)
{
    ECRDSA_KeyPair *keypair = (ECRDSA_KeyPair*)keyobj;
    ECRDSA_VrfySessD2b *sess = malloc(sizeof(ECRDSA_VrfySessD2b));
    if (sess == NULL) return NULL;
    memset(sess, 0, sizeof(ECRDSA_VrfySessD2b));
    ...
    return sess;
err:
    ECRDSA_d2b_vrfysess_free(sess);
    return NULL;
}


int ECRDSA_d2b_sign_offline(void *keyobj, void *sessobj, void *sigobj)
{
    /* Rename objects. */
    ECRDSA_KeyPair *keys = (ECRDSA_KeyPair*)keyobj;
    ECRDSA_SignSessD2b *sess = (ECRDSA_SignSessD2b*)sessobj;
    ECRDSA_Sig *sig = (ECRDSA_Sig*)sigobj;
    int ret;
...
int ECRDSA_d2b_sign_online(void *keyobj, void *sessobj, void *sigobj,
    const unsigned char *msg, int msglen)
{
    /* Cast objects. */
    ECRDSA_KeyPair *keys = (ECRDSA_KeyPair*)keyobj;
...
int ECRDSA_d2b_vrfy_offline(void *keyobj, void *sessobj, void *sigobj)
{
    return 0;
}


int ECRDSA_d2b_vrfy_online(void *keyobj, void *sessobj, void *sigobj, const unsigned char *msg, int msglen)
{
    /* Rename objects. */
    ECRDSA_KeyPair *keys = (ECRDSA_KeyPair*)keyobj;
    ECRDSA_VrfySessD2b *sess = (ECRDSA_VrfySessD2b*)sessobj;
    ECRDSA_Sig *sig = (ECRDSA_Sig*)sigobj;
    int ret;
...
SchemeMethods ECRDSA_Methods =
{
    ...
    .mthd_signsess_d3b_new = ECRDSA_d3b_signsess_new,
    .mthd_signsess_d3b_free = ECRDSA_d3b_signsess_free,
    .mthd_vrfysess_d3b_new = ECRDSA_d3b_vrfysess_new,
    .mthd_vrfysess_d3b_free = ECRDSA_d3b_vrfysess_free,
    .mthd_d3b_sign_offline = ECRDSA_d3b_sign_offline,
    .mthd_d3b_sign_online = ECRDSA_d3b_sign_online,
    .mthd_d3b_vrfy_offline = ECRDSA_d3b_vrfy_offline,
    .mthd_d3b_vrfy_online = ECRDSA_d3b_vrfy_online,
    ...
    .mthd_signsess_d2b_new = ECRDSA_d2b_signsess_new,
    .mthd_signsess_d2b_free = ECRDSA_d2b_signsess_free,
    .mthd_vrfysess_d2b_new = ECRDSA_d2b_vrfysess_new,
    .mthd_vrfysess_d2b_free = ECRDSA_d2b_vrfysess_free,
    .mthd_d2b_sign_offline = ECRDSA_d2b_sign_offline,
    .mthd_d2b_sign_online = ECRDSA_d2b_sign_online,
    .mthd_d2b_vrfy_offline = ECRDSA_d2b_vrfy_offline,
    .mthd_d2b_vrfy_online = ECRDSA_d2b_vrfy_online,
